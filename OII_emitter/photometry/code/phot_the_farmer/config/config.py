...
##### FILE LOCATION #####
WORKING_DIR = '/home/lupengjun/OII_emitter/photometry/phot_the_farmer/'
IMAGE_DIR = WORKING_DIR + 'data/images'										# INPUT Raw images, weights, and masks
PSF_DIR = WORKING_DIR + 'data/psfs'							# INTERMEDIATE Point-spread function files
BRICK_DIR = WORKING_DIR + 'data/bricks'							# INTERMEDIATE Bricks (i.e. subimages)
INTERIM_DIR = WORKING_DIR + 'data/interm'						# OUTPUT Other stuff I make 		
PLOT_DIR = WORKING_DIR + 'data/plots'							# OUTPUT Figures
CATALOG_DIR = WORKING_DIR + 'data/catalogs'					# OUTPUT Catalog
